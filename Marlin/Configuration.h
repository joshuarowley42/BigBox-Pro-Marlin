...
#define START_BMPHIGH // Enable Splash Screen
...
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 2 // the duration the buzzer plays the UI feedback sound. ie Screen Click
